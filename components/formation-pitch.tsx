...
export function FormationPitch({
  ...
  return (
    <div className="relative aspect-[3/4] w-full overflow-hidden rounded-xl border border-emerald-900/40 bg-gradient-to-b from-emerald-700 to-emerald-800 shadow-inner">
      <PitchMarkings />
  ...
  return (
    <button
      ...
      className={cn(
        ...
        highlight && "ring-2 ring-yellow-300 ring-offset-2 ring-offset-emerald-700",
      )}
    >
      <div
        className={cn(
